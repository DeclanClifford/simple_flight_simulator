...
% The function works out the influence of vortex line AB at control point C,
% returning zero if the
% denominator is less than 'small', so that self-influences are excluded.
